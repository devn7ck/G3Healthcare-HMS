...
if (isset($_POST['app-submit'])) {
  ...
  if (date("Y-m-d", $appdate1) >= $cur_date) {
    if ((date("Y-m-d", $appdate1) == $cur_date && date("H:i:s", $apptime1) > $cur_time) or date("Y-m-d", $appdate1) > $cur_date) {
...
if (isset($_GET["generate_bill"])) {
  ...
  $content .= '
      <br/>
      <h2 align ="center"> G3 Healthcare</h2></br>
...
<head>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
    ...
    <style>
      .bg-primary {
        background: -webkit-linear-gradient(left, #024E2E, #3CB371);
      }
                  ...
                  <tr>
                    ...
                    <td>
                      <?php if (($row['userStatus'] == 1) && ($row['doctorStatus'] == 1)) { ?>
                        ...
                        <a href="admin_dashboard.php?ID=<?php echo $row['ID'] ?>&cancel=update" onClick="return confirm('Are you sure you want to cancel this appointment ?')" title="Cancel Appointment" tooltip-placement="top" tooltip="Remove"><button class="btn btn-danger">Cancel</button></a>
                      <?php } else {
